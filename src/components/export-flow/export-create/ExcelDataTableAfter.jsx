...
//   pagination = { pageSize: 10 },
// }) => {
//   console.log("ExcelDataTableAfter Debug:", {
//     exportType,
//     providers,
//     data: data.slice(0, 2), // chỉ log 2 record đầu
//   });
//   // Helper để lấy tên nhà cung cấp từ providerId (nếu có)
//   const getProviderName = (record) => {
//     if (!record.providerId) return "";

//     // Tìm provider trong danh sách providers
//     const foundProvider = providers.find(
//       (p) => String(p.id) === String(record.providerId)
//     );

//     // ✅ THÊM: Fallback để handle cả format từ UseExportFirstStep
//     if (foundProvider) {
//       return foundProvider.name || foundProvider.providerName || "";
//     }

//     // ✅ THÊM: Tìm theo tên provider trực tiếp nếu providers chỉ có 1 item
//     if (providers.length === 1 && providers[0].name) {
//       return providers[0].name;
//     }
