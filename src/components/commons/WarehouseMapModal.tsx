...
interface WarehouseMapModalProps {
    importedItems: ItemResponse[] | undefined;
...
const WarehouseMapModal: React.FC<WarehouseMapModalProps> = ({ open, onClose, importedItems, inventoryItems, storedLocationData, loading, onConfirmLocation }) => {
    ...
    const handleUpdateLocation = (item: InventoryItemResponse) => {
        ...
        console.log('Cập nhật vị trí cho sản phẩm:', item);
    ...
    const handleFinalConfirm = async () => {
        ...
        try {
            // Tạo danh sách cập nhật vị trí từ inventoryItems hiện tại
            ...
            console.error('Lỗi khi xác nhận vị trí lưu kho:', error);
        } finally {
            setIsConfirming(false);
        }
    };
