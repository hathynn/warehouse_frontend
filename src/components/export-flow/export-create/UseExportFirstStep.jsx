...
//     return [];
//   });
//   // 6. Cải thiện onSelectChange
//   const onSelectChange = (newSelectedRowKeys) => {
//     setSelectedRowKeys(newSelectedRowKeys);

//     // ✅ TỰ ĐỘNG TÍNH TOÁN checkAll
//     if (selectedOrder && selectedOrder.importOrderDetails) {
//       const allKeys = selectedOrder.importOrderDetails.map(
//         (d) => d.importOrderDetailId
//       );
//       setCheckAll(
//         newSelectedRowKeys.length === allKeys.length &&
...
//       setCheckAll(false);
//     }
//   }, [selectedOrder, initialSelectedItems]); // ✅ DEPENDENCY ĐÚNG

//   // 5. Thêm validation để đảm bảo consistency
//   useEffect(() => {
//     // ✅ VALIDATE selectedRowKeys vs checkAll state
//     if (selectedOrder && selectedOrder.importOrderDetails) {
//       const allKeys = selectedOrder.importOrderDetails.map(
//         (d) => d.importOrderDetailId
//       );
//       const shouldCheckAll =
//         selectedRowKeys.length === allKeys.length && selectedRowKeys.length > 0;

//       if (checkAll !== shouldCheckAll) {
//         setCheckAll(shouldCheckAll);
//       }
//     }
...
//           actualQuantity: detail.actualQuantity,
//           status: detail.status,
//           importOrderDetailId: detail.importOrderDetailId, // ✅ THÊM FIELD NÀY
//         }));
...
//                   selectedOrder.importOrderDetails.length &&
//                   newSelectedKeys.length > 0
//               );
//             }
//           }}
